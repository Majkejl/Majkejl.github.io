...
// include: C:\Users\misic\AppData\Local\Temp\tmp77cb_t2o.js
...
Module['FS_createPath']("/C:/Users/misic/source/repos/fft_water_sim_", "resources", true, true);
    ...
    loadPackage({"files": [{"filename": "C:/Users/misic/source/repos/fft_water_sim_/resources/shader.wgsl", "start": 0, "end": 1467}, {"filename": "C:/Users/misic/source/repos/fft_water_sim_/resources/webgpu.txt", "start": 1467, "end": 2001}], "remote_package_size": 2001});

  })();

// end include: C:\Users\misic\AppData\Local\Temp\tmp77cb_t2o.js
// include: C:\Users\misic\AppData\Local\Temp\tmphu1tfcdm.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\misic\AppData\Local\Temp\tmphu1tfcdm.js
// include: C:\Users\misic\AppData\Local\Temp\tmpvinel894.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\misic\AppData\Local\Temp\tmpvinel894.js
